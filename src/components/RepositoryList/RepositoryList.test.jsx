  ...
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      repositoryItems.forEach((item, index) => {
        ...
        expect(item).toHaveTextContent(`${formatNumber(stargazersCount)}Stars`);
        expect(item).toHaveTextContent(`${formatNumber(forksCount)}Forks`);
        expect(item).toHaveTextContent(`${formatNumber(reviewCount)}Reviews`);
        expect(item).toHaveTextContent(`${formatNumber(ratingAverage)}Rating`);
      });
    });
  });
});
